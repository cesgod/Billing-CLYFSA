		...
		<div class="card-body">
		 <div class="card-content p-2">
		 	<div class="text-center">
		 		<img src="logo.png" alt="logo icon" width="50%">
		 	</div>
		    ...
		    <form action="checklogin.php" method="POST">
			  ...
			  <label for="exampleInputUsername" class="sr-only">Usuario</label>
			   <div class="position-relative has-icon-right">
				  <input name="user" type="text" id="exampleInputUsername" class="form-control input-shadow" placeholder="Usuario">
			  ...
			  <label for="exampleInputPassword" class="sr-only">Contraseña</label>
			   <div class="position-relative has-icon-right">
				  <input name="password" type="password" id="exampleInputPassword" class="form-control input-shadow" placeholder="Contraseña">
				  <div class="form-control-position">
					  <i class="icon-lock"></i>
				  </div>
			   </div>
