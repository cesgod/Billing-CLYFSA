...
<head>
  ...
  <title>Facturacion | CLYFSA</title>
  <!-- loader-->
   ...
   <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
        <a href="facturacion.php">
          <i class="zmdi zmdi-view-dashboard"></i> <span>Facturacion</span>
        </a>
      </li>
      <!--<li>
        <a href="profile.php">
...
<div class="row">
        ...
        <div class="col-lg-12">
            <div class="card-body">
              <h4 class="card-title">Sistema de Facturación</h4> 
              <H4></H4>
                  <!--<div class="cards">-->
                    ...
                    <table class="table table-hover" id="Mytable">
                      <thead>
                          <th>MeterName</th>
                          <th>id</th>
                          <th>EnergiaActTotal</th>
                          <th>EnergiaActFPC</th>
                          <th>EnergiaActPC</th>
                          <th>EnergiaReact</th>
                          <th>DemandaMaxTotal</th>
                          <th>DemandaMaxFPC</th>
                          <th>DemandaMaxPC</th>
                        ...
                        <?php
                          ...
                          if (count($data->stand)) {
                              ...
                              foreach ($data->stand as $idx => $stand) {
                                  ...
                                  echo "<td>$stand->id</td>";
                                  echo "<td>$stand->EnergiaActTotal</td>";
                                  echo "<td>$stand->EnergiaActFPC</td>";
                                  echo "<td>$stand->EnergiaActPC</td>";
                                  echo "<td>$stand->EnergiaReact</td>";
                                  echo "<td>$stand->DemandaMaxTotal</td>";
                                  echo "<td>$stand->DemandaMaxFPC</td>";
                                  echo "<td>$stand->DemandaMaxPC</td>";
                                  echo "<td>$stand->Fecha_de_cierre</td>";
                                  echo "</tr>";
                              }
